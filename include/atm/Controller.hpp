...
class Controller
{
 public:
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////
  Controller();
  Controller(std::string ip, int port, int databaseNum);
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////
  std::string addCustomer(std::unordered_map<std::string, std::string> custInfo);

  //////////////////////////////////////////////////////////////////////////////////////////////
  /// \brief Adds an account to a customer
  //////////////////////////////////////////////////////////////////////////////////////////////
  std::string addAccount(std::string custId);
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////
  bool customerExists(std::string custId);
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////
  bool deposit(std::string custId, std::string account, int amount);
